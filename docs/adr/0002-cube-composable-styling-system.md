---
title: ADR-0002 - CUBE-based composable styling system
description - Acrolls currently exposes broad `default` and `foundation` CSS entrypoints, while its styling
implementation and layout classes follow BEM-oriented naming.
---
